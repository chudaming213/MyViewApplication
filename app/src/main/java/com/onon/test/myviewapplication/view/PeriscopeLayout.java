...
public class PeriscopeLayout extends RelativeLayout {
	...
	private void init() {
		...
		Drawable red = getResources().getDrawable(R.mipmap.heart_red_small);
		Drawable yellow = getResources().getDrawable(R.mipmap.heart_red_small);
		Drawable blue = getResources().getDrawable(R.mipmap.heart_red_small);
		drawables[0] = red;
		drawables[1] = yellow;
		drawables[2] = blue;
		// 获取图的宽高 用于后面的计算
